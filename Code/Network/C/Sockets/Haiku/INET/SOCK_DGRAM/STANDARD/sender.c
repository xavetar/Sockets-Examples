...
int main() {
    ...
    // Haiku has some trouble/bug with AF_INET socket and need connect before sendto/send
    ...
    // Haiku has some trouble/bug with AF_INET socket and not support sendto after connect
